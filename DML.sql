...
INSERT INTO guia_remessa_cliente (data_envio, data_entrega, endereco_origem, endereco_chegada, estado_id, detalhe_encomenda_id, utilizador_id, fatura_id) VALUES
  ('2024-01-10', '2024-01-15', 'Armazém A', 'Endereço Cliente 1', 1, 1, 2, 1),
  ('2024-01-12', '2024-01-18', 'Armazém B', 'Endereço Cliente 2', 2, 2, 3, 2),
  ('2024-01-15', '2024-01-20', 'Armazém C', 'Endereço Cliente 3', 3, 3, 1, 3);
...
INSERT INTO guia_remessa_fornecedor (data_envio, data_entrega, endereco_origem, endereco_chegada, estado_id, detalhe_encomenda_id, utilizador_id, fatura_id) VALUES
  ('2024-01-10', '2024-01-15', 'Armazém Fornecedor 1', 'Endereço Fornecedor 1', 1, 1, 2, 1),
  ('2024-01-12', '2024-01-18', 'Armazém Fornecedor 2', 'Endereço Fornecedor 2', 2, 2, 3, 2),
  ('2024-01-15', '2024-01-20', 'Armazém Fornecedor 3', 'Endereço Fornecedor 3', 3, 3, 1, 3);
